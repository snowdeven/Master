...
integer, parameter :: Nsteps = 2000          !nb of MC sweeps (cycles)
integer, parameter :: Nequil = 0             !equilibration period
!--------------------------------------------------------------------
...
! ***********************************************************************
! WARNING: in the 'spin' array, one counts starting from 0 and not from 1
! ***********************************************************************
integer :: i, j, k
